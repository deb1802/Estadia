...
@php
  // Imagen por sexo del autor (fallback simple)
...
<div class="foro-wrapper">
  <div class="foro-container">
    <h2 class="foro-header">
      Testimonios @if(auth()->user()?->tipoUsuario === 'admin') <small class="text-muted">· Moderación</small> @endif
    </h2>
    ...
    @forelse($testimonios as $t)
      ...
      <div class="testimonio">
        ...
        {{-- Meta / Acciones (ver respuestas y moderar) --}}
        <div class="meta-row">
          ...
          @can('delete', $t)
            <form action="{{ route('admin.testimonios.destroy', $t->idTestimonio) }}"
              ...
              <button type="submit" class="btn btn-sm btn-outline-danger"
                      onclick="return confirm('¿Eliminar este testimonio? Esta acción no se puede deshacer.')">
                Eliminar testimonio
              </button>
            </form>
          @endcan
