...
<div class="container py-4">
    <div class="card shadow p-4">
        <h3 class="mb-4 text-primary">
            <i class="fas fa-file-medical"></i> Nuevo expediente clínico
        </h3>

        {!! Form::open(['route' => 'medico.expedientes.store', 'method' => 'POST']) !!}

        {{-- Selección de paciente --}}
        <div class="form-group mb-3">
            {!! Form::label('fkPaciente', 'Paciente', ['class' => 'form-label fw-bold']) !!}
            {!! Form::select('fkPaciente', $pacientes, null, ['class' => 'form-control', 'required', 'placeholder' => 'Selecciona un paciente']) !!}
        </div>
        ...
        <div class="text-end">
            <a href="{{ route('medico.expedientes.index') }}" class="btn btn-outline-secondary">
