  ...
  <div class="card card-body shadow-sm mb-3 card-search">
    <div class="search-bar">
      <div class="search-input-group">
        <input type="text" id="search-input" class="form-control" placeholder="Buscar tutores..." autocomplete="off">
      ...
      <a href="{{ route('medico.tutores.create') }}" class="btn btn-add shadow-sm">
        <i class="fas fa-user-plus"></i> Agregar nuevo tutor
      </a>
    </div>
  </div>
...
<script>
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    const baseUrl = @json(route('medico.tutores.index'));
