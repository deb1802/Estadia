...
<style>
  ...
  /* ===== Botón agregar ===== */
  .btn-add {
    background: linear-gradient(135deg, #6c63ff, #8d7aff);
    border: none;
    color: #fff;
    border-radius: 10px;
    padding: 10px 16px;
  ...
  .btn-add:hover {
    background: linear-gradient(135deg, #5b54e0, #7a6bf5);
  ...
  <div class="card card-body shadow-sm mb-3 card-search">
    <div class="search-bar">
      <div class="search-input-group">
        <input type="text" id="search-input" class="form-control" placeholder="Buscar citas..." autocomplete="off">
      ...
      <a href="{{ route('medico.citas.create') }}" class="btn-add">
